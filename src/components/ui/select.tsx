...
function SelectValue({ className, ...props }: SelectPrimitive.Value.Props) {
  return (
    <SelectPrimitive.Value
      ...
      // min-w-0 lets a long label shrink; without it the trigger's min-content width
      // stretches its grid/flex parent and the whole page scrolls sideways.
